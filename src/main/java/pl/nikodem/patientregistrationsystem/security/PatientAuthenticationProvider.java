...
import pl.nikodem.patientregistrationsystem.service.PatientDetailsService;

@Component
public class PatientAuthenticationProvider implements AuthenticationProvider {
    private final PatientDetailsService patientService;
    private final PasswordEncoder passwordEncoder;

    @Autowired
    public PatientAuthenticationProvider(PatientDetailsService patientService, PasswordEncoder passwordEncoder) {
